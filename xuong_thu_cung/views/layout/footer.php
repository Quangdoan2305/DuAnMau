    ...
    <div class="footer-top section-padding">
        <div class="container">
            <div class="row">
                    ...
                    <div class="widget-item">
                        <div class="widget-title">
                            <div class="widget-logo">
                                <a href="<?= BASE_URL ?>">
                                    <img style="width: 120px" src="assets/img/logo/lvd.png" alt="brand logo">
                                </a>
                            </div>
                        </div>
                        <div class="widget-body">
                            <p>Chúng tôi luôn cố gắng mang lại những sản phẩm tốt nhất cho khách hàng</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-2 col-md-6">
                    <div class="widget-item">
                        <h6 class="widget-title fs-2">Liên hệ</h6>
                        <div class="widget-body">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="widget-item">
                        <h6 class="widget-title  fs-2">Thông tin</h6>
                        <div class="widget-body">
                            <ul class="info-list">
                ...
                <div class="col-lg-4 col-md-4">
                    <div class="widget-item ">
                        <h6 class="widget-title fs-2">Theo dõi chúng tôi</h6>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="copyright-text text-center">
                        <p>&copy; 2024 <b>LVD</b> Made with <i class="fa fa-heart text-danger"></i> by <a href="https://hasthemes.com/"><b>LVD ENTERTAIMENT</b></a></p>
                    </div>
                </div>
            </div>
        </div>
