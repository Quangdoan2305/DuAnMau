...
<main>
    ...
    <section class="slider-area">
        <div class="hero-slider-active slick-arrow-style slick-arrow-style_hero slick-dot-style">
            ...
            <div class="hero-single-slide hero-overlay">
                <div class="hero-slider-item bg-img" data-bg="assets/img/slider/home1-slide2.png">
                    <div class="container">
                        <div class="row">
                        </div>
                    </div>
            ...
            <!-- single slider item start -->
            <div class="hero-single-slide hero-overlay">
                <div class="hero-slider-item bg-img" data-bg="assets/img/slider/home1-slide3.png">
                    <div class="container">
                        <div class="row">
                        </div>
                    </div>
            ...
            <!-- single slider item start -->
            <div class="hero-single-slide hero-overlay">
                <div class="hero-slider-item bg-img" data-bg="assets/img/slider/home1-slide1.png">
                    <div class="container">
                        <div class="row">
                        </div>
                    </div>
            ...
            <div class="row mtn-30">
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="policy-item">
                        ...
                        <div class="policy-content">
                            <h6>Hoàn lại tiền</h6>
                            <p>Hoàn lại tiền trong vong 30 ngày</p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-3">
            ...
            <div class="row row-20 mtn-20">
                <div class="col-sm-6">
                    <figure class="banner-statistics mt-20">
                        <a href="#">
                            <img src="assets/img/banner/airpod4.png" alt="product banner">
                        </a>
                    </figure>
                </div>
                <div class="col-sm-6">
                    <figure class="banner-statistics mt-20">
                        <a href="#">
                            <img src="assets/img/banner/ssgalaxy.png" alt="product banner">
                        </a>
                    </figure>
                </div>
                <div class="col-sm-6">
                    <figure class="banner-statistics mt-20">
                        <a href="#">
                            <img src="assets/img/banner/laptopAI.png" alt="product banner">
                        </a>
                    </figure>
                </div>
                <div class="col-sm-6">
                    ...
                    <div class="product-banner-carousel slick-row-10">
                        ...
                        <div class="banner-slide-item">
                            <figure class="banner-statistics">
                                <a href="#">
                                    <img src="assets/img/banner/iphone_16_pro_max_1.png" alt="product banner">
                                </a>
                                <div class="banner-content banner-content_style2">
                                    <h5 class="banner-text3"><a href="#">iPhone 16 Pro Max</a></h5>
                                </div>
                            </figure>
                        </div>
                        <!-- banner single slide start -->
                        ...
                        <div class="banner-slide-item">
                            <figure class="banner-statistics">
                                <a href="#">
                                    <img src="assets/img/banner/lap_top_1.jpg" alt="product banner">
                                </a>
                                <div class="banner-content banner-content_style2">
                                    <h5 class="banner-text3"><a href="#">Laptop Gaming Asus</a></h5>
                                </div>
                            </figure>
                        </div>
                        <!-- banner single slide start -->
                        ...
                        <div class="banner-slide-item">
                            <figure class="banner-statistics">
                                <a href="#">
                                    <img src="assets/img/banner/samsung-galaxy-s24-ultra-1.png" alt="product banner">
                                </a>
                                <div class="banner-content banner-content_style2">
                                    <h5 class="banner-text3"><a href="#">Samsung Galaxy S24 Ultra</a></h5>
                                </div>
                            </figure>
                        </div>
                        <!-- banner single slide start -->
                        ...
                        <div class="banner-slide-item">
                            <figure class="banner-statistics">
                                <a href="#">
                                    <img src="assets/img/banner/samsung-galaxy-z-flip4-1.jpg" alt="product banner">
                                </a>
                                <div class="banner-content banner-content_style2">
                                    <h5 class="banner-text3"><a href="#">Samsung Galaxy Z Flip4</a></h5>
                                </div>
                            </figure>
                        </div>
                        <!-- banner single slide start -->
                        ...
                        <div class="banner-slide-item">
                            <figure class="banner-statistics">
                                <a href="#">
                                    <img src="assets/img/banner/iphone-15-promax-1.jpg" alt="product banner">
                                </a>
                                <div class="banner-content banner-content_style2">
                                    <h5 class="banner-text3"><a href="#">iPhone 15 Pro Max</a></h5>
                                </div>
                            </figure>
                        </div>
                        <!-- banner single slide start -->
    ...
    <section class="testimonial-area section-padding bg-img" data-bg="assets/img/testimonial/anh1.jpg">
        <!-- <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="section-title text-center">
                        <h2 class="title">Lời chứng thực</h2>
