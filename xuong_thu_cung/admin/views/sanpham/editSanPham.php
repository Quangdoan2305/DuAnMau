          ...
          <form action="<?= BASE_URL_ADMIN . '?act=sua-san-pham' ?> " method="POST" enctype="multipart/form-data">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <select id="danh_muc" name="danh_muc_id" class="form-control custom-select">
              ...
              <div class="form-group">
                ...
                <textarea id="mo_ta" class="form-control" rows="4"><?= $sanPham['mo_ta'] ?></textarea>
              </div>
            ...
            <form action="<?= BASE_URL_ADMIN . '?act=sua-album-anh-san-pham' ?> " method="POST" enctype="multipart/form-data">
              <div class="table-responsive">
                <table id="faqs" class="table table-hover">
                  ...
                  <tbody>
                    <input type="hidden" name="san_pham_id" value="<?= $sanPham['id'] ?>">
                    <input type="hidden" name="img_delete" name="img_delete">
...
<script>
  ...
  function addfaqs() {
    ...
    html += '<td><img src="https://i.pinimg.com/236x/c3/64/d6/c364d6301a9930870001a32a13b0fa4e.jpg" style="width:50px; height:50px ;" alt=""></td>';
